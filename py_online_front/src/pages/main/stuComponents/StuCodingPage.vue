    ...
    <div>
        ...
        <el-row style="margin-bottom: 5px">
            ...
            <el-col :span="4" :offset="1">
                ...
                <!-- 提交按钮 -->
                <el-button type="primary" round plain size="small" @click="submitReport">提交报告</el-button>
            </el-col>
            <!-- 主题选择器 -->
            <el-col :span="2">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            // 提交报告
            submitReport(){
                this.$confirm('确认提交报告并退出吗？', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    let form = {code:this.curCode,params:this.pyParams};
                    this.$axios.post("/ReportCon/submitReport",form).then((res)=>{
                        if(res.data.flag){
